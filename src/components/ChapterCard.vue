<template>
  <div
    @click="goToChapter"
    class="inline-flex items-center justify-start px-4 py-2 border border-transparent rounded-sm cursor-pointer shadow  text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
  >
